...
def getfacts(zuverwendendezeilen,sorted_gptarray):
    ...
    for element in zuverwendendezeilen:
        ...
        prompt = "Generate " +str(factcount) + " short facts, which aren't too general, for the topic" + str(topic) + ". They should all begin with a number, and it is really important that they are formatted in a python list. The facts should be separated in multiple parts, indicated with a ; how they would be spoken."
